...
class DeliveryOrder(db.Model):
    ...
    items = db.relationship('DeliveryOrderItem', backref='delivery_order', cascade="all, delete-orphan", lazy='joined')

class DeliveryOrderItem(db.Model):
    __tablename__ = 'DeliveryOrderItem'
    delivery_id = db.Column(db.String, db.ForeignKey('DeliveryOrder.delivery_id'), primary_key=True)
